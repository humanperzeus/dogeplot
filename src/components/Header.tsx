                                ...
                                <div className="absolute hidden group-hover:block right-0 top-full mt-2 p-3 bg-zinc-900/95 backdrop-blur border border-zinc-800 rounded-lg shadow-xl w-64 z-50">
                                  <div className="space-y-2">
                                    <div className="flex items-center justify-between">
                                      ...
                                      <Badge className="bg-primary-light/20 text-primary-light text-xs">v1.0.3</Badge>
                                    </div>
                                    <div className="flex items-center justify-between">
                                    ...
                                    <div className="pt-2 border-t border-zinc-800">
                                      <div className="text-xs text-zinc-300 space-y-1">
                                        <div className="flex items-start gap-2">
                                          ...
                                          <span>Added bill statistics dashboard</span>
                                        </div>
                                        <div className="flex items-start gap-2">
                                          <span className="text-primary-light">•</span>
                                          <span>Enhanced semantic search visualization</span>
                                        </div>
                                        <div className="flex items-start gap-2">
                                          <span className="text-primary-light">•</span>
                                          <span>Improved bill sync process with quiet mode</span>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                            ...
                            <div className="space-y-6">
                              <div className="glass-panel p-4 rounded-lg space-y-4">
                                <div className="flex items-center justify-between">
                                  ...
                                  <span className="text-primary-light font-medium">v1.0.3</span>
                                </div>
                                <div className="flex items-center justify-between">
                              ...
                              <div className="glass-panel p-4 rounded-lg space-y-4">
                                ...
                                <div className="space-y-6 max-h-[300px] overflow-y-auto pr-2">
                                  <div className="space-y-2">
                                    ...
                                    <ul className="space-y-1 text-xs text-zinc-300">
                                      <li className="flex items-start gap-1">
                                        ...
                                        <span>Added bill statistics dashboard showing Congress 118 & 119 counts</span>
                                      </li>
                                      <li className="flex items-start gap-1">
                                        <span className="text-primary-light mt-1">•</span>
                                        <span>Created interactive semantic bill network visualization</span>
                                      </li>
                                      <li className="flex items-start gap-1">
                                        <span className="text-primary-light mt-1">•</span>
                                        <span>Improved bill sync process with quiet mode and UI updates</span>
                                      </li>
                                      <li className="flex items-start gap-1">
                                        <span className="text-primary-light mt-1">•</span>
                                        <span>Enhanced vectorization status display for AI-ready bills</span>
                                      </li>
                                      <li className="flex items-start gap-1">
                                        <span className="text-primary-light mt-1">•</span>
                                        <span>Added latest data update tracking with cutoff date display</span>
                                      </li>
                                    </ul>
                                  </div>
                                  ...
                                  <div className="space-y-2">
                                    <div className="flex items-center gap-2">
                                      <span className="text-emerald-400 text-sm">v1.0.2</span>
                            ...
                            <div className="space-y-2">
                              ...
                              <div className="pt-2 border-t border-zinc-800">
                                <div className="text-xs text-zinc-300 space-y-1">
                                  ...
                                  <div className="flex items-start gap-2">
                                    <span className="text-primary-light">•</span>
                                    <span>Better mobile viewport optimization</span>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="space-y-6 max-h-[300px] overflow-y-auto pr-2">
                            <div className="space-y-2">
                              ...
                              <ul className="space-y-1 text-xs text-zinc-300">
                                <li className="flex items-start gap-1">
                                  <span className="text-primary-light mt-1">•</span>
                                  <span>Enhanced semantic search with button-triggered search</span>
                                </li>
                                <li className="flex items-start gap-1">
                                  <span className="text-primary-light mt-1">•</span>
                                  <span>Improved bill information display with complete details</span>
                                </li>
                                <li className="flex items-start gap-1">
                                  <span className="text-primary-light mt-1">•</span>
                                  <span>Real-time bill count updates after search completion</span>
                                </li>
                                <li className="flex items-start gap-1">
                                  <span className="text-primary-light mt-1">•</span>
                                  <span>Added similarity badges for search relevance</span>
                                </li>
                                <li className="flex items-start gap-1">
                                  <span className="text-primary-light mt-1">•</span>
                                  <span>Separated deployment architecture for better scaling</span>
                                </li>
                              </ul>
                            </div>
