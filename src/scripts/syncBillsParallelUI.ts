// This file contains UI improvements for syncBillsParallel.ts
// Copy the updateDisplay function from here to replace the one in syncBillsParallel.ts

/**
 * Updates the display with progress information
 * @param workerStats Map of worker statistics
 * @param options Script options including limit and threads
 */
