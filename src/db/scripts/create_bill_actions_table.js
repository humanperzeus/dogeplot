...
async function createBillActionsTable() {
  console.log('Creating bill_actions table...\n')

  // Create the table using RPC
  const { error: rpcError } = await supabase.rpc('create_bill_actions_table', {
    sql: `
...
createBillActionsTable().catch(console.error) 