// CommonJS version of diagnostic script
// Run with: node diagnose.cjs
...
console.log('🔍 DIAGNOSTICS TOOL (COMMONJS VERSION)');
console.log('====================================\n');
...
try {
  ...
  if (packageJson.type === 'module') {
    console.log('⚠️ NOTE: This project is configured as an ES module. This can cause issues with CommonJS scripts.');
    console.log('To fix the issues with the diagnostic scripts, run: node fix-esm-issues.js');
  }
